...
// Плюс факт «почта настроена»: фронт не должен обещать письмо, если код уходит в лог.
app.get("/api/auth-providers", (c) => c.json({ providers: enabledSocialProviders(), email: emailEnabled() }));
