...
// M3-габариты (итерация 4, «прям как у Google»): все кнопки — пилюли,
// высоты 40/48dp, крупные горизонтальные отступы. Меняется здесь ОДИН раз
// и красит и лендинг, и ЛК.
